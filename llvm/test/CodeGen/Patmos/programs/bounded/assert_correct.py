...
def compile_and_test(llc_args, pasim_args):
    ...
    if not using_singlepath:
        llc_compile_arg_list = llc_compile_arg_list + ["-mpatmos-serialize=" + compiled + ".pml", "-mpatmos-serialize-functions=" + sp_root]
    ...
    if not using_singlepath:
        ...
        platin_arg_list = "platin wcet -i" + pml_name + " -b " + compiled + " -e " + sp_root + " --report --verbose --target-call-return-costs"
